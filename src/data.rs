...
pub(crate) static ATTRIBUTES: phf::Map<&'static str, AttributeTag> = phf::phf_map! {
    ...
    "TAGame.Vehicle_TA:bReplicatedHandbrake" => AttributeTag::ReplicatedHandbrake,
    "TAGame.Vehicle_TA:ReplicatedSteer" => AttributeTag::ReplicatedSteer,
    "TAGame.Vehicle_TA:ReplicatedThrottle" => AttributeTag::ReplicatedThrottle,
